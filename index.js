    ...
    app.get("/init", async (req, res) => {
      ...
      try {
        ...
        const data = {
          ...
          success_url: `${process.env.CLIENT_SITE_URL}/explore`,
          fail_url: `${process.env.CLIENT_SITE_URL}/explore`,
          cancel_url: `${process.env.CLIENT_SITE_URL}/explore`,
          ipn_url: `${process.env.CLIENT_SITE_URL}/explore`,
